...
const StudentEnrollment = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Insert student without registration_number - it will be auto-generated by the database
      const studentData: Omit<Student, 'id' | 'created_at' | 'updated_at' | 'registration_number' | 'admission_date'> = {

  ...
  return (
    <div className="relative min-h-screen space-y-8">
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('https://images.unsplash.com/photo-1580582932707-520aed937b7b?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80')"
        }}
      />
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {statsCards.map((card, index) => (
            <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden bg-white/90 backdrop-blur-sm">
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                {Object.entries(gradeStats).map(([grade, count]) => (
                  <div key={grade} className="text-center p-6 border border-gray-100 rounded-xl bg-gradient-to-br from-white/95 to-gray-50/95 hover:shadow-md transition-shadow duration-200 backdrop-blur-sm">
